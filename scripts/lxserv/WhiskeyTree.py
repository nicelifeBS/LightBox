...
# _theTree.AddNode('Speyside')
# _theTree.AddNode('Speyside1')
# _theTree.AddNode('Speyside2')
# _theTree.AddNode('Speyside3')
# _theTree.AddNode('Speyside4')
...
class WhiskyTreeView(lxifc.TreeView,
    ...
    def attr_GetString(self, index):
        node = self.m_currentNode.m_children[self.m_currentIndex]
...
tags = {lx.symbol.sSRV_USERNAME: "whiskytreeview",
        lx.symbol.sTREEVIEW_TYPE: "vpapplication WSTV whiskytreeview Whisky_Tree"}
